...
const sheetLoader = new SheetLoader('1ae0nTowaSivDqV6CHlac59VW-6jGwPB8qcillwafMiU', apis.sheets, null);
...
function getCpt(pic) {
  if (pic) {
    let foundPartner = cpts.partners.find(partner => (partner.pic && (partner.pic === pic))) || null;
    return foundPartner;
  } else {
    return null;
  }
