...
export function DonateDialog({ data: { clickLink }}: DonateDialogProps) {
  ...
  return (
    ...
    {/* <div className='border border-white border-opacity-50 p-4 space-y-4 mx-4'> */}
      ...
      <p className='text-white text-center widget:text-sm text-balance'>We make all of our resources available at no cost to churches, schools and families around the world. Would you consider supporting our work?</p>
      <center>
        <a
        ...
        >
          <Image src={dontateIcon} alt='Donate' className='size-5 widget:size-4' />
          DONATE
        </a>
      </center>
