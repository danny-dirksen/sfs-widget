...
function PopupContainer(props: PopupContainerProps) {
  ...
  return (
    <div className='absolute top-0 left-0 w-full h-full flex justify-center items-center p-2 md:p-8 overflow-hidden'>
      <div className='w-full max-w-2xl min-h-30 h-fit max-h-full overflow-y-scroll bg-white text-black shadow-lg pb-4'>
        <div className='text-right'>
          <Image className='size-8 inline-block p-2 hover:bg-black hover:bg-opacity-10 cursor-pointer' alt='X' src={x} onClick={onCloseMe} />
        </div>
