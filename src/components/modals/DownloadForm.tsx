        ...
        text: {
          init: (
            <>
              ...
              <Paragraph>
                Enter your email address below to receive a free download link.
              </Paragraph>
            </>
          ),
          failed: (
            <>
              ...
              <Image
                alt="Email Sent"
                className="w-12 inline mb-4 opacity-30"
                src={mailIcon}
              />
              <Paragraph>We had trouble sending the link. Try again?</Paragraph>
            </>
          ),
          sent: (
            <>
              ...
              <Image
                alt="Email Sent"
                className="w-12 inline mb-4"
                src={mailIcon}
              />
              <Paragraph>We have sent the download link.</Paragraph>
            </>
          ),
        },
