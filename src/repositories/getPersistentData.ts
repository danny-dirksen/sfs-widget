...
import { varReadJSON, logger, varWriteJSON } from "@/utils/varUtils";
import { PersistentData, PersistentDataSchema } from "./persistentData";
...
const sheetCache: CacheLevel<PersistentData> = {
  read: async () => {
    ...
    return await parseSheet(spreadsheetRepo);
  },
};
